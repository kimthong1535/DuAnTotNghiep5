...
use App\Http\Controllers\Client\CommemtController;
...
//======================= Phần client
// quản lý đơn hàng
Route::get('/account', [ManageController::class, 'account'])->name('accout.accout');
Route::get('/account/orders', [ManageController::class, 'orders'])->name('accout.orders');
Route::get('/account/addresses', [ManageController::class, 'addresses'])->name('accout.addresses');
Route::get('/account/order-detail/{code}', [ManageController::class, 'order_detail'])->name('accout.order_detail');
Route::get('/account/alear', [ManageController::class, 'alear'])->name('accout.alear');
// trang home
Route::get('/home', [HomeController::class, 'index'])->name('home.index');
Route::get('/', [HomeController::class, 'index'])->name('index');
// tìm kiếm sản phẩm
Route::post('/search', [HomeController::class, 'search'])->name('search.search');
Route::post('/search-ajax', [HomeController::class, 'autocomplate_search'])->name('autocomplate_ajax.search');
//chi tiết sản phẩm
...
// bình luân
Route::post('/send-commemt', [CommemtController::class, 'send_commemt'])->name('send.commemt');
// view bình luận 
Route::post('/commemt', [CommemtController::class, 'index'])->name('load.commemt');
// phần giỏ hàng
...
Route::post('/update-cart/', [CartController::class, 'update_cart'])->name('cart.update_cart');
// mã giảm giá
...
Route::group(['prefix' => 'admin', 'namespace' => 'Backend'],function(){
    ...
    // bình luận
    Route::prefix('/commemt')->group(function () {
        Route::get('/',[CommemtController::class, 'show_commemt'])->name('commemt.show_commemt');
        Route::post('/allow-commemt',[CommemtController::class, 'allow_commemt'])->name('allow.commemt');
        Route::post('/reply-commemt',[CommemtController::class, 'reply_commemt'])->name('reply.commemt');
    });
// quản lý đơn hàng
Route::prefix('/order')->group(function () {
        ...
        Route::post('/huy-don-hang',[OrderController::class, 'huy_don_hang'])->name('huy.don_hang');
