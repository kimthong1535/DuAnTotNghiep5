  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        @endforeach
        <a class="see-more" href="{{ url ('category/21') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        <h3 class="text--title m-0 ml-3">{{ $value->category_name }}</h3>
        @endforeach
        <a class="see-more" href="{{ url ('category/24') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
      <div class="category__content d-flex flex-nowrap align-items-stretch">
        <div class="category__image">
          <figure class="box__image ">
  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        <h3 class="text--title m-0 ml-3">{{ $value->category_name }}</h3>
        @endforeach
        <a class="see-more" href="{{ url ('category/22') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
      <div class="category__content d-flex flex-nowrap align-items-stretch">
        <div class="category__image">
          <figure class="box__image ">
  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        <h3 class="text--title m-0 ml-3">{{ $value->category_name }}</h3>
        @endforeach
        <a class="see-more" href="#{{ url ('category/25') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
      <div class="category__content d-flex flex-nowrap align-items-stretch">
        <div class="category__image">
          <figure class="box__image ">
  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        <h3 class="text--title m-0 ml-3">{{ $value->category_name }}</h3>
        @endforeach
        <a class="see-more" href="{{ url ('category/23') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
      <div class="category__content d-flex flex-nowrap align-items-stretch">
        <div class="category__image">
          <figure class="box__image ">
  ...
  <div class="col-md-6 mb-20 col-pl-10 col-pr-10">
    <div class="category rounded bg-white">
      <div class="title">
        ...
        <h3 class="text--title m-0 ml-3">{{ $value->category_name }}</h3>
        @endforeach
        <a class="see-more" href="{{ url ('category/28') }}">Xem tất cả <i class="fal fa-angle-right"></i></a>
      </div>
      <div class="category__content d-flex flex-nowrap align-items-stretch">
        <div class="category__image">
          <figure class="box__image ">
